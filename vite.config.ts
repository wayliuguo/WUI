...
import { name, version } from './packages/package.json'
...
export default (): UserConfigExport => {
  return {
    ...
    plugins: [
       ...
       * vue 插件
       *
       * @see vite-plugin-vue https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue-jsx
       */
      vueJsx(),
      /**
       * vue 插件
    ...
    build: {
      ...
      lib: {
        name: 'WUI',
        entry: resolve(__dirname, 'packages/index.ts') /** 打包入口 */
      },
      /**
       * rollup 配置项
       *

...
<span class="line"><span style="color:#A6ACCD;">    /&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">  )</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="renderlabel" tabindex="-1">renderLabel <a class="header-anchor" href="#renderlabel" aria-label="Permalink to &quot;renderLabel&quot;">​</a></h2><ul><li>渲染 <code>label</code></li><li>优先渲染插槽，其次props</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderLabel = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    )</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="rendertitle" tabindex="-1">renderTitle <a class="header-anchor" href="#rendertitle" aria-label="Permalink to &quot;renderTitle&quot;">​</a></h2><ul><li>渲染<code>title</code></li><li>优先渲染插槽，其次props</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderText = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    )</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="renderrighticon" tabindex="-1">renderRightIcon <a class="header-anchor" href="#renderrighticon" aria-label="Permalink to &quot;renderRightIcon&quot;">​</a></h2><ul><li>渲染右侧 icon</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderRightIcon = () =&gt; {</span></span>

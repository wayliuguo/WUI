import{_ as s,o as n,c as a,O as l}from"./chunks/framework.4015372c.js";const D=JSON.parse('{"title":"hooks","description":"","frontmatter":{},"headers":[],"relativePath":"guide/notes/hooks.md"}'),e={name:"guide/notes/hooks.md"},p=l(`<h1 id="hooks" tabindex="-1">hooks <a class="header-anchor" href="#hooks" aria-label="Permalink to &quot;hooks&quot;">​</a></h1><h2 id="usechildren-ts" tabindex="-1">useChildren.ts <a class="header-anchor" href="#usechildren-ts" aria-label="Permalink to &quot;useChildren.ts&quot;">​</a></h2><h3 id="usechildren" tabindex="-1">useChildren <a class="header-anchor" href="#usechildren" aria-label="Permalink to &quot;useChildren&quot;">​</a></h3><ul><li>导出了<code>publicChildren</code>,<code>linkChildren</code></li><li><code>publicChildren</code>：元素下的子元素</li><li><code>linkChildren</code>：接收一个value入参 <ul><li>通过 provide 提供了一个对象，包括<code>link、unlink、internalChildren、children、value</code></li><li><code>link</code>：往公共子元素数组中收集并排序（链接子元素）</li><li><code>unlink</code>: 解除子元素链接</li><li><code>value</code>：公共变量</li></ul></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">export function useChildren&lt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  })</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div>`,42),o=[p];function t(c,i,r,C,A,d){return n(),a("div",null,o)}const u=s(e,[["render",t]]);export{D as __pageData,u as default};

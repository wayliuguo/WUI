...
<span class="line"><span style="color:#A6ACCD;">} as const</span></span></code></pre></div><h2 id="setup" tabindex="-1">setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;setup&quot;">​</a></h2><h2 id="hascontent" tabindex="-1">hasContent <a class="header-anchor" href="#hascontent" aria-label="Permalink to &quot;hasContent&quot;">​</a></h2><ul><li>通过 <code>插槽</code>的<code>content</code> 判断是否有定义徽标</li><li>通过 <code>props</code> 的 <code>content、showZero</code>，判断是否需要展示0</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const hasContent = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="style-computed" tabindex="-1">style Computed <a class="header-anchor" href="#style-computed" aria-label="Permalink to &quot;style Computed&quot;">​</a></h2><ul><li>根据 <code>offset</code> 和 <code>positon</code> 设置徽标的偏移量及位置</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const getOffsetWithMinusString = (val: string) =&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h2 id="renderbadge" tabindex="-1">renderBadge <a class="header-anchor" href="#renderbadge" aria-label="Permalink to &quot;renderBadge&quot;">​</a></h2><ul><li>渲染徽标</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderBadge = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    )</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="render" tabindex="-1">render <a class="header-anchor" href="#render" aria-label="Permalink to &quot;render&quot;">​</a></h2><ul><li>如果有默认插槽才进行插槽和徽标的渲染</li><li>否则只渲染徽标</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">return () =&gt; {</span></span>
<span class="line"><span style="color:#A6ACCD;">  if (slots.default) {</span></span>
<span class="line"><span style="color:#A6ACCD;">    return (</span></span>

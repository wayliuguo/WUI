...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">export type SpaceProps = ExtractPropTypes&lt;typeof spaceProps&gt;</span></span></code></pre></div><h2 id="setup" tabindex="-1">setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;setup&quot;">​</a></h2><h3 id="mergedalign" tabindex="-1">mergedAlign <a class="header-anchor" href="#mergedalign" aria-label="Permalink to &quot;mergedAlign&quot;">​</a></h3><ul><li>获取对齐方式，用于设置类名</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const mergedAlign = computed(</span></span>
<span class="line"><span style="color:#A6ACCD;">  () =&gt; props.align ?? (props.direction === &#39;horizontal&#39; ? &#39;center&#39; : &#39;&#39;)</span></span>
<span class="line"><span style="color:#A6ACCD;">)</span></span></code></pre></div><h3 id="getmargin" tabindex="-1">getMargin <a class="header-anchor" href="#getmargin" aria-label="Permalink to &quot;getMargin&quot;">​</a></h3><ul><li>通过<code>size</code>获取间距</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const getMargin = (size: SpaceSize) =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="filterempty" tabindex="-1">filterEmpty <a class="header-anchor" href="#filterempty" aria-label="Permalink to &quot;filterEmpty&quot;">​</a></h3><ul><li>过滤空 VNode</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const filterEmpty = (children: VNode[] = []) =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">      )</span></span>
<span class="line"><span style="color:#A6ACCD;">  )</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="render" tabindex="-1">render <a class="header-anchor" href="#render" aria-label="Permalink to &quot;render&quot;">​</a></h3><ul><li>遍历过滤后的vNode进行渲染</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">return () =&gt; {</span></span>

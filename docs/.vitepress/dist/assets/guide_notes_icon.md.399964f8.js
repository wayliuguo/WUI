...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">export type IconProps = ExtractPropTypes&lt;typeof iconProps&gt;</span></span></code></pre></div><h2 id="setup" tabindex="-1">setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;setup&quot;">​</a></h2><h2 id="isimage" tabindex="-1">isImage <a class="header-anchor" href="#isimage" aria-label="Permalink to &quot;isImage&quot;">​</a></h2><ul><li>判断是否图片链接</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const isImage = (name?: string) =&gt; name?.includes(&#39;/&#39;)</span></span>
<span class="line"><span style="color:#A6ACCD;">const isImageIcon = isImage(name)</span></span></code></pre></div><h2 id="render" tabindex="-1">render <a class="header-anchor" href="#render" aria-label="Permalink to &quot;render&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">return (</span></span>

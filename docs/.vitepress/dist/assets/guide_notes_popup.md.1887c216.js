import{_ as s,o as n,c as a,O as l}from"./chunks/framework.4015372c.js";const F=JSON.parse('{"title":"Popup","description":"","frontmatter":{},"headers":[],"relativePath":"guide/notes/popup.md"}'),p={name:"guide/notes/popup.md"},o=l(`<h1 id="popup" tabindex="-1">Popup <a class="header-anchor" href="#popup" aria-label="Permalink to &quot;Popup&quot;">​</a></h1><h2 id="props" tabindex="-1">props <a class="header-anchor" href="#props" aria-label="Permalink to &quot;props&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">export const popupSharedProps = {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">]</span></span></code></pre></div><h2 id="setup" tabindex="-1">setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;setup&quot;">​</a></h2><h3 id="uselazyrender-lazyrender" tabindex="-1">useLazyRender &amp; lazyRender <a class="header-anchor" href="#uselazyrender-lazyrender" aria-label="Permalink to &quot;useLazyRender &amp; lazyRender&quot;">​</a></h3><ul><li><a href="./hooks.html#use-lazy-render-ts">useLazyRender</a>返回一个函数。</li><li>这个函数接收一个<code>JSX.Element</code>入参的函数，这个函数根据<code>props.show || !props.lazyRender</code>执行。</li><li><code>position</code> 设置位置。</li><li><code>round</code> 设置圆角。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const popupRef = ref&lt;HTMLElement&gt;()</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">    &lt;/div&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">  )</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h3 id="style" tabindex="-1">style <a class="header-anchor" href="#style" aria-label="Permalink to &quot;style&quot;">​</a></h3><ul><li>设置层级与动画/渐变时间。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const style = computed(() =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h3 id="open" tabindex="-1">open <a class="header-anchor" href="#open" aria-label="Permalink to &quot;open&quot;">​</a></h3><ul><li>使用自定义<code>zIndex</code> 或<a href="./hooks.html#use-global-z-index-ts">全局zIndex</a></li><li><code>emit(&#39;open&#39;)</code></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const open = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    })</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="onclickoverlay" tabindex="-1">onClickOverlay <a class="header-anchor" href="#onclickoverlay" aria-label="Permalink to &quot;onClickOverlay&quot;">​</a></h3><ul><li>派发<code>clickOverlay</code></li><li>根据<code>closeOnClickOverlay</code>调用<code>close</code></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const onClickOverlay = (event: MouseEvent): void =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    close()</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="renderoverlay" tabindex="-1">renderOverlay <a class="header-anchor" href="#renderoverlay" aria-label="Permalink to &quot;renderOverlay&quot;">​</a></h3><ul><li>渲染遮罩层。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderOverlay = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    )</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="rendercloseicon" tabindex="-1">renderCloseIcon <a class="header-anchor" href="#rendercloseicon" aria-label="Permalink to &quot;renderCloseIcon&quot;">​</a></h3><ul><li>渲染关闭按钮。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderCloseIcon = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    )</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="onclickcloseicon" tabindex="-1">onClickCloseIcon <a class="header-anchor" href="#onclickcloseicon" aria-label="Permalink to &quot;onClickCloseIcon&quot;">​</a></h3><ul><li>点击关闭按钮。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const onClickCloseIcon = (event: MouseEvent) =&gt; {</span></span>
<span class="line"><span style="color:#A6ACCD;">  emit(&#39;clickCloseIcon&#39;, event)</span></span>
<span class="line"><span style="color:#A6ACCD;">  close()</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="onopened" tabindex="-1">onOpened <a class="header-anchor" href="#onopened" aria-label="Permalink to &quot;onOpened&quot;">​</a></h3><ul><li>弹窗打开后派发<code>opened</code>事件。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">let timer: ReturnType&lt;typeof setTimeout&gt; | null</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  })</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="onclosed" tabindex="-1">onClosed <a class="header-anchor" href="#onclosed" aria-label="Permalink to &quot;onClosed&quot;">​</a></h3><ul><li>派发<code>closed</code>事件。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const onClosed = () =&gt; emit(&#39;closed&#39;)</span></span></code></pre></div><h3 id="onkeydown" tabindex="-1">onKeydown <a class="header-anchor" href="#onkeydown" aria-label="Permalink to &quot;onKeydown&quot;">​</a></h3><ul><li>派发<code>keydown</code>事件。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const onKeydown = (event: KeyboardEvent) =&gt; emit(&#39;keydown&#39;, event)</span></span></code></pre></div><h3 id="rendertransition" tabindex="-1">renderTransition <a class="header-anchor" href="#rendertransition" aria-label="Permalink to &quot;renderTransition&quot;">​</a></h3><ul><li>使用<code>Transition</code>, 定义<code>onAfterEnter</code>与<code>onAfterLeave</code>。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderTransition = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    &gt;&lt;/Transition&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">  )</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="watch" tabindex="-1">watch <a class="header-anchor" href="#watch" aria-label="Permalink to &quot;watch&quot;">​</a></h3><ul><li>监听 <code>props.show</code>，进行关闭与开启。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">watch(</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">)</span></span></code></pre></div><h3 id="useexpose" tabindex="-1">useExpose <a class="header-anchor" href="#useexpose" aria-label="Permalink to &quot;useExpose&quot;">​</a></h3><ul><li>通过自定义<code>hooks</code><a href="./hooks.html#use-expose-ts">useExpose</a>暴露 popupRef。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">useExpose({ popupRef })</span></span></code></pre></div><h3 id="uselockscroll" tabindex="-1">useLockScroll <a class="header-anchor" href="#uselockscroll" aria-label="Permalink to &quot;useLockScroll&quot;">​</a></h3><ul><li>通过<a href="./hooks.html#use-lock-scroll-ts">useLockScroll</a>进行滚动的控制。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">useLockScroll(popupRef, () =&gt; props.show &amp;&amp; props.lockScroll)</span></span></code></pre></div><h3 id="useeventlistener" tabindex="-1">useEventListener <a class="header-anchor" href="#useeventlistener" aria-label="Permalink to &quot;useEventListener&quot;">​</a></h3><ul><li>路由退出后根据配置关闭。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">useEventListener(&#39;popstate&#39;, () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h3 id="onmounted-onactivated-ondeactivated" tabindex="-1">onMounted &amp; onActivated &amp; onDeactivated <a class="header-anchor" href="#onmounted-onactivated-ondeactivated" aria-label="Permalink to &quot;onMounted &amp; onActivated &amp; onDeactivated&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">onMounted(() =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h3 id="provide" tabindex="-1">provide <a class="header-anchor" href="#provide" aria-label="Permalink to &quot;provide&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">provide(POPUP_TOGGLE_KEY, () =&gt; props.show)</span></span></code></pre></div><h3 id="render" tabindex="-1">render <a class="header-anchor" href="#render" aria-label="Permalink to &quot;render&quot;">​</a></h3><ul><li>如果<code>teleport</code>，结合<code>Teleport</code>组件<code>to</code>属性渲染到特定<code>DOM</code>。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">return () =&gt; {</span></span>

import{_ as s,o as n,c as a,O as l}from"./chunks/framework.4015372c.js";const F=JSON.parse('{"title":"Loading","description":"","frontmatter":{},"headers":[],"relativePath":"guide/notes/loading.md"}'),p={name:"guide/notes/loading.md"},o=l(`<h1 id="loading" tabindex="-1">Loading <a class="header-anchor" href="#loading" aria-label="Permalink to &quot;Loading&quot;">​</a></h1><h2 id="props" tabindex="-1">props <a class="header-anchor" href="#props" aria-label="Permalink to &quot;props&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">export type LoadingType = &#39;circular&#39; | &#39;spinner&#39;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    &lt;/span&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">  )</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h3 id="spinicon-circularicon" tabindex="-1">SpinIcon &amp; CircularIcon <a class="header-anchor" href="#spinicon-circularicon" aria-label="Permalink to &quot;SpinIcon &amp; CircularIcon&quot;">​</a></h3><ul><li>两种类型的加载默认样式</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">onst SpinIcon: JSX.Element[] = Array(12)</span></span>
...
<span class="line"><span style="color:#A6ACCD;">)</span></span></code></pre></div><h3 id="rendertext" tabindex="-1">renderText <a class="header-anchor" href="#rendertext" aria-label="Permalink to &quot;renderText&quot;">​</a></h3><ul><li>默认插槽就是文字的插槽，如果定义了文字就执行</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderText = () =&gt; {</span></span>

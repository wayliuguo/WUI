import{_ as s,o as n,c as a,O as l}from"./chunks/framework.ff144929.js";const u=JSON.parse('{"title":"Row","description":"","frontmatter":{},"headers":[],"relativePath":"guide/notes/row.md"}'),p={name:"guide/notes/row.md"},e=l(`<h1 id="row" tabindex="-1">Row <a class="header-anchor" href="#row" aria-label="Permalink to &quot;Row&quot;">​</a></h1><h2 id="props" tabindex="-1">props <a class="header-anchor" href="#props" aria-label="Permalink to &quot;props&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">export type RowAlign = &#39;top&#39; | &#39;center&#39; | &#39;bottom&#39;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">export type RowProps = ExtractPropTypes&lt;typeof rowProps&gt;</span></span></code></pre></div><h2 id="setup" tabindex="-1">setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;setup&quot;">​</a></h2><h2 id="injection" tabindex="-1">injection <a class="header-anchor" href="#injection" aria-label="Permalink to &quot;injection&quot;">​</a></h2><ul><li>使用 InjectionKey 指定注入的类型。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">export type RowSpaces = { left?: number; right: number }[]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h2 id="spaces" tabindex="-1">spaces <a class="header-anchor" href="#spaces" aria-label="Permalink to &quot;spaces&quot;">​</a></h2><ul><li><code>averagePadding</code>：平均的padding，如<code>[0,1,2]</code>需要<code>2*gutter/3</code></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const spaces = computed(() =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">  return spaces</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h2 id="render" tabindex="-1">render <a class="header-anchor" href="#render" aria-label="Permalink to &quot;render&quot;">​</a></h2><ul><li>添加上属性控制的样式</li><li>把插槽渲染</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">return () =&gt; {</span></span>

...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">export type OverlayProps = ExtractPropTypes&lt;typeof overlayProps&gt;</span></span></code></pre></div><h2 id="setup" tabindex="-1">setup <a class="header-anchor" href="#setup" aria-label="Permalink to &quot;setup&quot;">​</a></h2><h3 id="uselazyrender-renderoverlay" tabindex="-1">useLazyRender &amp; renderOverlay <a class="header-anchor" href="#uselazyrender-renderoverlay" aria-label="Permalink to &quot;useLazyRender &amp; renderOverlay&quot;">​</a></h3><ul><li><a href="./hooks.html#use-lazy-render-ts">useLazyRender</a>返回一个函数。</li><li>这个函数接收一个<code>JSX.Element</code>入参的函数，这个函数根据<code>props.show</code>执行。</li><li><a href="./utilsFunction.html#getzindexstyle">getZIndexStyle</a>返回层级。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const lazyRender = useLazyRender(() =&gt; props.show || !props.lazyRender)</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h3 id="render" tabindex="-1">render <a class="header-anchor" href="#render" aria-label="Permalink to &quot;render&quot;">​</a></h3><ul><li>使用<code>Transition</code>结合<code>name</code>属性控制渐变。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">return () =&gt; (</span></span>

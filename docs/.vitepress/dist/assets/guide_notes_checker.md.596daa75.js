...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;">  return {}</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h2 id="onclick" tabindex="-1">onClick <a class="header-anchor" href="#onclick" aria-label="Permalink to &quot;onClick&quot;">​</a></h2><ul><li>点击触发</li><li>如果非不可选中且（点击的是icon或者没有禁用label点击），<code>emit(&#39;toggle&#39;)</code></li><li><code>emit(&#39;click&#39;, event)</code></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const iconRef = ref&lt;HTMLElement&gt;()</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="rendericon" tabindex="-1">renderIcon <a class="header-anchor" href="#rendericon" aria-label="Permalink to &quot;renderIcon&quot;">​</a></h2><ul><li>如果有定义<code>icon 插槽</code>，则通过<code>作用域插槽</code>给<code>插槽</code>传递状态<a href="/wui/component/radio.html#自定义图标">使用</a></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderIcon = () =&gt; {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    &lt;/div&gt;</span></span>
<span class="line"><span style="color:#A6ACCD;">  )</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><h2 id="renderlabel" tabindex="-1">renderLabel <a class="header-anchor" href="#renderlabel" aria-label="Permalink to &quot;renderLabel&quot;">​</a></h2><ul><li>渲染<code>label</code>,指定样式</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">const renderLabel = () =&gt; {</span></span>
